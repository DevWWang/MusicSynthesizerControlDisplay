...
// Preset 2D-array
int storage_temp[6][18];
int storage_preset_1[6][18];
int storage_preset_2[6][18];
int storage_preset_3[6][18];
int storage_preset_4[6][18] = {
	{1, 88, 37, 88, 37, 88, 37, 88, 37, 88, 37, 88 ,37, 88, 37, 3, 2, 6},
	{1, 88, 37, 88, 37, 88, 37, 88, 37, 88, 37, 88, 37, 88, 37, 3, 1, 6},
	{1, 88, 37, 88, 37, 88, 37, 88, 37, 88, 37, 88, 37, 88, 37, 3, 3, 6},
	{1, 88, 37, 88, 37, 88, 37, 88, 37, 88, 37, 88, 37, 88, 37, 3, 3, 6},
	{1, 88, 37, 88, 37, 88, 37, 88, 37, 88, 37, 88, 37, 88, 37, 3, 0, 6},
	{1, 88, 37, 88, 37, 88, 37, 88, 37, 88, 37, 88, 37, 88, 37, 3, 0, 6}
};
int storage_preset_5[6][18] = {
	{1, 4, 1, 61, 88, 127, 88, 63, 88, 127, 88, 59 ,88, 2, 88, 3, 1, 43},
	{1, 56, 1, 57, 87, 127, 87, 64, 87, 127, 87, 65, 87, 3, 87, 2, 1, 43},
	{1, 5, 1, 61, 88, 127, 88, 60, 88, 127, 88, 62, 88, 4, 88, 3, 1, 43},
	{1, 4, 1, 62, 88, 127, 88, 61, 88, 127, 88, 57, 88, 4, 88, 1, 1, 43},
	{1, 6, 1, 87, 55, 39, 55, 84, 55, 38, 55, 38, 55, 4, 55, 0, 1, 43},
	{0, 60, 1, 60, 1, 60, 1, 60, 1, 60, 1, 60, 1, 60, 1, 0, 1, 43}
};
int storage_preset_6[6][18] = {
	{0, 8, 1, 57, 38, 127, 38, 57, 38, 57, 1, 36 ,1, 5, 1, 1, 1, 39},
	{0, 5, 1, 63, 38, 127, 38, 58, 38, 58, 1, 27, 1, 6, 1, 2, 1, 39},
	{1, 6, 1, 57, 88, 127, 88, 61, 88, 127, 88, 41, 1, 4, 1, 3, 1, 39},
	{0, 57, 1, 57, 1, 57, 1, 57, 1, 57, 1, 57, 1, 57, 1, 0, 1, 39},
	{0, 57, 1, 57, 1, 57, 1, 57, 1, 57, 1, 57, 1, 57, 1, 0, 1, 39},
	{0, 57, 1, 57, 1, 57, 1, 57, 1, 57, 1, 57, 1, 57, 1, 0, 1, 39}
};
int storage_preset_7[6][18] = {
	{0, 8, 1, 64, 38, 127, 38, 67, 38, 67, 1, 3, 1, 11, 1, 0, 1, 25},
	{0, 11, 1, 58, 38, 127, 38, 65, 38, 65, 1, 33, 1, 9, 1, 2, 1, 25},
	{0, 61, 1, 61, 1, 61, 1, 61, 1, 61, 1, 61, 1, 61, 1, 0, 2, 25},
	{0, 61, 1, 61, 1, 61, 1, 61, 1, 61, 1, 61, 1, 61, 1, 0, 2, 25},
	{0, 61, 1, 61, 1, 61, 1, 61, 1, 61, 1, 61, 1, 61, 1, 0, 2, 25},
	{0, 61, 1, 61, 1, 61, 1, 61, 1, 61, 1, 61, 1, 61, 1, 0, 2, 25}
};
...
void XfsSetPresetSelected(int pre_1, int pre_2, int pre_3, int pre_4, int pre_5, int pre_6, int pre_7) {
	if (pre_1 == 1 && pre_2 == 0 && pre_3 == 0 && pre_4 == 0 && pre_5 == 0 && pre_6 == 0 && pre_7 == 0) {
		preset_selected = PRESET_1;
		//printf("preset_selected = %d\n", preset_selected);
	}
	if (pre_1 == 0 && pre_2 == 1 && pre_3 == 0 && pre_4 == 0 && pre_5 == 0 && pre_6 == 0 && pre_7 == 0) {
		preset_selected = PRESET_2;
		//printf("preset_selected = %d\n", preset_selected);
	}
	if (pre_1 == 0 && pre_2 == 0 && pre_3 == 1 && pre_4 == 0 && pre_5 == 0 && pre_6 == 0 && pre_7 == 0) {
		preset_selected = PRESET_3;
		//printf("preset_selected = %d\n", preset_selected);
	}
	if (pre_1 == 0 && pre_2 == 0 && pre_3 == 0 && pre_4 == 1 && pre_5 == 0 && pre_6 == 0 && pre_7 == 0) {
		preset_selected = PRESET_4;
		//printf("preset_selected = %d\n", preset_selected);
	}
	if (pre_1 == 0 && pre_2 == 0 && pre_3 == 0 && pre_4 == 0 && pre_5 == 1 && pre_6 == 0 && pre_7 == 0) {
		preset_selected = PRESET_5;
		//printf("preset_selected = %d\n", preset_selected);
	}
	if (pre_1 == 0 && pre_2 == 0 && pre_3 == 0 && pre_4 == 0 && pre_5 == 0 && pre_6 == 1 && pre_7 == 0) {
		preset_selected = PRESET_6;
		//printf("preset_selected = %d\n", preset_selected);
	}
	if (pre_1 == 0 && pre_2 == 0 && pre_3 == 0 && pre_4 == 0 && pre_5 == 0 && pre_6 == 0 && pre_7 == 1) {
		preset_selected = PRESET_7;
		//printf("preset_selected = %d\n", preset_selected);
	}
}

int XfsGetPresetNumber() {
	return preset_selected;
}

void XfsSavingPreset(int saving_mode, int preset_nb, int i, int j, int value) {
	if (saving_mode == 1) {
		switch(preset_nb) {
			case PRESET_1:
				storage_preset_1[i][j] = value;
				break;
			case PRESET_2:
				storage_preset_2[i][j] = value;
				break;
			case PRESET_3:
				storage_preset_3[i][j] = value;
				break;
			case PRESET_4:
				storage_preset_4[i][j] = value;
				break;
			case PRESET_5:
				storage_preset_5[i][j] = value;
				break;
			case PRESET_6:
				storage_preset_6[i][j] = value;
				break;
			case PRESET_7:
				storage_preset_7[i][j] = value;
				break;
			default:
				storage_temp[i][j] = value;
				break;
		}
	}
}

void printPresetStorage(int preset_nb) {
	int i, j;
	switch(preset_nb) {
		case PRESET_1:
			printf("Preset 1\n");
...
void DataTransmitted(int type, int preset_nb, int op_nb, int wave_type, int mode_type, int level_set, int amp_value, int time_value, int mod_coef, int arr_choice) {
	if (type == TYPE_PRESET) {
		uint32_t preset_bit;
		preset_bit = preset_nb;
		*(uint32_t *)input_arbitration_addr = preset_bit << 25;
	}
	if (type == TYPE_USER_SETTING) {
		uint32_t setting_mode_bit, op_bit, op_wave_bit, op_mode_bit, level_set_bit, amp_value_bit, time_value_bit, mod_coef_bit, arr_choice_bit;
		setting_mode_bit = 1; //1 bit
		op_bit = op_nb; //3 bits
		op_wave_bit = wave_type; //2 bits
		op_mode_bit = mode_type; //1 bit
		level_set_bit = level_set; //3 bits
		amp_value_bit = amp_value; //7 bits
		time_value_bit = time_value; //7 bits
		mod_coef_bit = mod_coef; //2 bits
		arr_choice_bit = arr_choice; //6 bits
		*(uint32_t *)input_arbitration_addr = setting_mode_bit << 31 | op_bit << 28 | op_wave_bit << 26 | op_mode_bit << 25 | level_set_bit << 22 | amp_value_bit << 15 | time_value_bit << 8 | mod_coef_bit << 6 | arr_choice_bit;
		//printf("op_bit = %d, op_wave_bit = %d, op_mode_bit = %d\n", op_bit, op_wave_bit, op_mode_bit);
		//printf("level_set_bit = %d, amp_value_bit = %d, time_value_bit = %d\n", level_set_bit, amp_value_bit, time_value_bit);
		//printf("mod. coef = %d, arrangement no. = %d\n", mod_coef_bit, arr_choice_bit);
	}
}

void XfsLoadPreset(int saving_mode, int preset_nb, int loading[6][18]) {
	int i, j;
	if (saving_mode != 1) {
		switch(preset_nb) {
			case PRESET_1:
				...
				for (i = 0; i < 6; i++) {
					for (j = 0; j < 18; j++) {
						loading[i][j] = storage_preset_1[i][j];
					}
				}
				break;
			case PRESET_2:
				...
				for (i = 0; i < 6; i++) {
					for (j = 0; j < 18; j++) {
						loading[i][j] = storage_preset_2[i][j];
					}
				}
				break;
			case PRESET_3:
				...
				for (i = 0; i < 6; i++) {
					for (j = 0; j < 18; j++) {
						loading[i][j] = storage_preset_3[i][j];
					}
				}
				break;
			case PRESET_4:
				...
				for (i = 0; i < 6; i++) {
					for (j = 0; j < 18; j++) {
						loading[i][j] = storage_preset_4[i][j];
					}
				}
				break;
			case PRESET_5:
				...
				for (i = 0; i < 6; i++) {
					for (j = 0; j < 18; j++) {
						loading[i][j] = storage_preset_5[i][j];
					}
				}
				break;
			case PRESET_6:
				...
				for (i = 0; i < 6; i++) {
					for (j = 0; j < 18; j++) {
						loading[i][j] = storage_preset_6[i][j];
					}
				}
				break;
			case PRESET_7:
				...
				for (i = 0; i < 6; i++) {
					for (j = 0; j < 18; j++) {
						loading[i][j] = storage_preset_7[i][j];
					}
				}
				break;
			default:
...
void XfsDrawSlider(Display *display, Window w, int x, int y, int width, int height, char *label, int activate) {
	...
	const char *time_label = "Time Stamp";
	...
	if (strcmp(label, time_label) == 0) {
		// Slider background base
		XDrawRectangle(display, w, gc_up, 0, 0, width, height);
		XDrawLine(display, w, gc, 190, 0, 190, height);
		XDrawLine(display, w, gc, 280, 0, 280, height);
		XDrawLine(display, w, gc, 440, 0, 440, height);
		XDrawLine(display, w, gc, 540, 0, 540, height);
		XDrawLine(display, w, gc, 590, 0, 590, height);
		XDrawLine(display, w, gc, 610, 0, 610, height);
		XDrawLine(display, w, gc, 615, 0, 615, height);
		XDrawLine(display, w, gc, 620, 0, 620, height);
		XDrawLine(display, w, gc, 625, 0, 625, height);
		XDrawLine(display, w, gc, 630, 0, 630, height);
		XDrawLine(display, w, gc, 635, 0, 635, height);
	}
	else {
		// Slider background base
		XDrawRectangle(display, w, gc_up, 0, 0, width, height);
...
int XfsCalculateOperatorSlider(int type, int value) {
	...
	switch(type) {
		case TYPE_COEF:
			...
			if (value > 67 && value < 136) {
				temp = 1;
			}
			if (value > 135 && value < 205) {
				temp = 2;
			}
			if (value > 204) {
				temp = 3;
...
int XfsConvertToXAxis(int time_index) {
	...
	if (time_index < 122) {
		...
		if (time_index > 37 && time_index < 56) {
			temp = 15;
		}
		if (time_index > 55 && time_index < 88) {
			temp = 23;
		}
		if (time_index > 87 && time_index < 108) {
			temp = 29;
		}
		if (time_index > 107 && time_index < 118) {
			temp = 35;
		}
		if (time_index > 117 && time_index < 122) {
			temp = 40;
		}

	}
	else if (time_index > 121) {
		int diff = (time_index - 121) / 3;
		temp = 40 + diff;
	}
}
...
char *XfsConvertToAlgorithm(int value) {
	char *algorithm_no = "";
	switch(value) {
		case 1:
			algorithm_no = "1";
...
char *XfsConvertToCoefficient(int value) {
	char *coefficient = "";
	switch(value) {
		case 0:
			coefficient = "0.5";
...
void XfsSavingPresetForOperator(int saving_mode, int preset_nb, int i, int j, int value) {
	if (saving_mode == 1) {
		switch(preset_nb) {
			case PRESET_1:
				storage_preset_1[i][j] = value;
...
char *XfsGetOperatorSliderStatus(char *mod_coef_value, char *arr_option_value) {
	char *seperator = ", ";
	char *coef_label = "Coeff:";
	char *arr_label = "Alg No.";
	// +1 for the zero-terminator;
	int status_size = strlen(coef_label) + strlen(mod_coef_value) + strlen(seperator) + strlen(arr_label) + strlen(arr_option_value);
	char *status = (char *)malloc(status_size + 1);
	strcpy(status, coef_label);
	strcat(status, mod_coef_value);
	strcat(status, seperator);
	strcat(status, arr_label);
	strcat(status, arr_option_value);
	return status;
}
...
void XfsDrawFMDisplay(Display *display, Window w, int x, int y, int width, int height, char *label, int activate) {
	...
	label = (char *)XfsGetOperatorSliderStatus((char *)XfsConvertToCoefficient(XfsGetModulationCoefficient()), (char *)XfsConvertToAlgorithm(XfsGetArrangementOption()));
	...
	XDrawText(display, w, gc, 30, height - 10, ti, 1);
	XUnloadFont(display, font->fid);
}

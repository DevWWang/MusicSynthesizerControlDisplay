...
int state_op_1 = 0, state_op_2 = 0, state_op_3 = 0, state_op_4 = 0, state_op_5 = 0, state_op_6 = 0;
...
int main(int argc, char *argv) {
	...
	w = XCreateSimpleWindow(dpy, DefaultRootWindow(dpy), 0, 0, 600, 500, 0, ltbrownColor, ltbrownColor);
		...
		switch (e.type) {
			...
			case ButtonPress:
				if (win_ret == w_op_1) {
					...
					printf("*OP_1 = [%d], OP_2 = [%d], OP_3 = [%d]\n", state_op_1, state_op_2, state_op_3);
					printf("OP_4 = [%d], OP_5 = [%d], OP_6 = [%d]\n", state_op_4, state_op_5, state_op_6);
					//XfsGetOperatorButtonNumber(findSelectedOperator(state_op_1, state_op_2, state_op_3, state_op_4, state_op_5,state_op_6), state_op_1);
				}
				if (win_ret == w_op_2) {
					...
					printf("OP_1 = [%d], *OP_2 = [%d], OP_3 = [%d]\n", state_op_1, state_op_2, state_op_3);
					printf("OP_4 = [%d], OP_5 = [%d], OP_6 = [%d]\n", state_op_4, state_op_5, state_op_6);
					//XfsGetOperatorButtonNumber(findSelectedOperator(state_op_1, state_op_2, state_op_3, state_op_4, state_op_5,state_op_6), state_op_2);
				}
				if (win_ret == w_op_3) {
					...
					printf("OP_1 = [%d], OP_2 = [%d], *OP_3 = [%d]\n", state_op_1, state_op_2, state_op_3);
					printf("OP_4 = [%d], OP_5 = [%d], OP_6 = [%d]\n", state_op_4, state_op_5, state_op_6);
					//XfsGetOperatorButtonNumber(findSelectedOperator(state_op_1, state_op_2, state_op_3, state_op_4, state_op_5,state_op_6), state_op_3);
				}
				if (win_ret == w_op_4) {
					...
					printf("OP_1 = [%d], OP_2 = [%d], OP_3 = [%d]\n", state_op_1, state_op_2, state_op_3);
					printf("*OP_4 = [%d], OP_5 = [%d], OP_6 = [%d]\n", state_op_4, state_op_5, state_op_6);
					//XfsGetOperatorButtonNumber(findSelectedOperator(state_op_1, state_op_2, state_op_3, state_op_4, state_op_5,state_op_6), state_op_4);
				}
				if (win_ret == w_op_5) {
					...
					printf("OP_1 = [%d], OP_2 = [%d], OP_3 = [%d]\n", state_op_1, state_op_2, state_op_3);
					printf("OP_4 = [%d], *OP_5 = [%d], OP_6 = [%d]\n", state_op_4, state_op_5, state_op_6);
					//XfsGetOperatorButtonNumber(findSelectedOperator(state_op_1, state_op_2, state_op_3, state_op_4, state_op_5,state_op_6), state_op_5);
				}
				if (win_ret == w_op_6) {
					...
					printf("OP_1 = [%d], OP_2 = [%d], OP_3 = [%d]\n", state_op_1, state_op_2, state_op_3);
					printf("OP_4 = [%d], OP_5 = [%d], *OP_6 = [%d]\n", state_op_4, state_op_5, state_op_6);
					//XfsGetOperatorButtonNumber(findSelectedOperator(state_op_1, state_op_2, state_op_3, state_op_4, state_op_5,state_op_6), state_op_6);
				}
				break;
		}
	}

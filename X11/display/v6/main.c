...
int main(int argc, char *argv) {
	...
	w_fm = XfsCreateLevelDrawing(dpy, w, x_fm, y_fm, 200, 260, "FM");
	...
	w_save = XfsCreateOperatorButton(dpy, w, x_level_set_2 + 40, y_set_2 + 5, SAVE_BUTTON_WIDTH, SAVE_BUTTON_HEIGHT, "SAVE");
